...
\frametitle{Actividades Asincr\'onicas}
	\begin{itemize}
		\item Producci\'on o Creaci\'n: Realice el diseño de un decodificador ABCD a display de 7 segmentos.
		\item Juego Did\'actico: Ampliar la practica sobre configuraciones de circuitos combinacionales \href{https://es.educaplay.com/recursos-educativos/4647989-circuitos_combinacionales.html}{\textcolor{blue}{Link.}}
		\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		\item Morris, M., y Ciletti, M. Diseño Digital, Cap. 4, pág. 150-181.
		\item Argüello D. M, Pérez, S., y Facchini, H. Arquitectura de computadoras, Cap.5, pág. 102-118.
		\end{itemize}
\end{frame}
