...
\frametitle{Actividades Asincr\'onicas}
	\begin{itemize}
		\item Producci\'on o Creaci\'on: Haciendo uso del software de simuaci\'on Multisim, realice un sumador de 3 bits con compuertas l\'ogicas.
		\item Juego Did\'actico: Afinar conceptos sobre circuitos combinaciones de compuertas lógicas para encender un led.
\href{https://www.cerebriti.com/juegos-de-matematicas/compuertas-logicas}{\textcolor{blue}{Link}}
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		\item Morris, M., y Ciletti, M. Diseño Digital, Cap. 4, pág. 125-150.
		\item Argüello D. M, Pérez, S., y Facchini, H. Arquitectura de computadoras, Cap.4, pág. 82-99.
		\end{itemize}
\end{frame}
