...
\frametitle{Actividades Asincr\'onicas}
	\begin{itemize}
		\item Elaboraci\'on de Documento: Utilizando el formato del paper $IEEE$, realice y suba el informe acá sobre la conexión de equipos de alimentación con el protoboard y circuitos integrados.
		\item Indagaci\'on: Utilizando la AI investigue y comente en el foro sobre los circuitos integrados del tipo CI7400, 7402, 7404, 7408, 7432, 7486, características y hojas de datos.
		\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		\item Morris, M., y Ciletti, M. Diseño Digital, Cap. 9, pág. 443-446.
		\item Argüello D. M, Pérez, S., y Facchini, H. Arquitectura de computadoras, Cap.4, pág. 82-89.
		\end{itemize}
\end{frame}
