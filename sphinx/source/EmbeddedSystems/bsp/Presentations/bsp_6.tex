...
\frametitle{Actividades Asincr\'onicas}
	\begin{itemize}
		\item Producci\'on o Creaci\'on: Realizar un ejemplo pr\'actico, simulado en el software Multisim, utilizando circuitos integrados de la familia TTL.
		\item An\'alisis de Caso: Realizar un ejercicio de pr\'actica sobre mapas de Karnaugh.
		\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		\item Morris, M., y Ciletti, M. Diseño Digital, Cap. 3, pág. 97-108.
