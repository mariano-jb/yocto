...
\frametitle{Actividades Asincr\'onicas}
	\begin{itemize}
		\item Producci\'on o Creaci\'on: Utilizando el Software de simulacion Multisim, realizar un contador binario con flip-flops.
		\item Reflexi\'on: Realizaremos una investigación con ejemplos pr\'acticos sobre, las tablas y diagramas de estado de los circuitos secuenciales sincrónicos.
		\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		\item Morris, M., y Ciletti, M. Diseño Digital, Cap. 5, pág. 190-203.
		\item Argüello D. M, Pérez, S., y Facchini, H. Arquitectura de computadoras, Cap.5, pág. 119-120.
		\end{itemize}
\end{frame}
